...
(defparameter *text*
  '(
    ...
    (text "あの旅行者が行方不明になった事件ですか、と村長の顔が曇る。"
          "この村にも警察の捜索が入ったが結局三人のうちの二人は見つからなかったそうだ。")
    (skill ("心理学" 105 107))
    ...
    30 ;;28
    (text "あなたはもう一度熊の像の腹を撫で地面を元に戻し、木箱をリュックに入れそそくさと車に乗り込んだ。"
    ...
    32 ;;30
    (text "早く帰ろうとするあなたですが、旅の疲れとなれない土地のせいか同じ場所を何度も通っている気がした。"
